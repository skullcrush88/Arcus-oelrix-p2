...
function App() {
  ...
  return (
    <div className="bg-white">
      <nav
        className="fixed top-0 left-0 right-0 z-50 px-12 py-8 flex justify-between items-center transition-opacity duration-300"
        style={{ opacity: navOpacity, pointerEvents: navOpacity === 0 ? 'none' : 'auto' }}
      >
        <div className="text-sm tracking-[0.3em] font-light">ARCUS</div>
        <div className="flex gap-12 text-[10px] tracking-[0.4em] font-light">
          <button
      ...
      <section className="h-screen flex flex-col items-center justify-center bg-white relative overflow-hidden">
        <div className="text-center z-10 px-8">
          <h1 className="text-8xl mb-6" style={{ color: '#1A1A1A' }}>Space. Refined.</h1>
          <p className="text-base tracking-[0.3em] font-light" style={{ color: '#1A1A1A' }}>
      ...
      >
        <div className="h-px mb-32 mx-auto" style={{ backgroundColor: '#1A1A1A', opacity: 0.15, maxWidth: '1400px' }}></div>

        <div className="max-w-[1400px] mx-auto grid grid-cols-2 gap-24">
          <div className="flex items-center">
            <p className="text-5xl leading-tight italic" style={{ color: '#1A1A1A' }}>
              We design spaces that speak before anyone enters the room.
            </p>
          </div>

          <div className="flex items-center">
            <p className="text-base leading-loose font-light" style={{ color: '#1A1A1A', opacity: 0.75 }}>
      ...
      <section id="projects-section" className="py-40 px-12 bg-white">
        <div className="max-w-[1600px] mx-auto">
          <h2 className="text-sm tracking-[0.4em] font-light mb-20" style={{ color: '#1A1A1A', opacity: 0.5 }}>
            SELECTED PROJECTS
          </h2>

          <div className="grid grid-cols-12 gap-6 auto-rows-[280px]">
            <div className="col-span-7 row-span-2 group overflow-hidden">
              <img
            ...
            <div className="col-span-5 row-span-1 group overflow-hidden">
              <img
            ...
            <div className="col-span-7 row-span-1 group overflow-hidden">
              <img
      ...
      <section className="py-40 px-12" style={{ backgroundColor: '#F5F2EE' }}>
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-3 divide-x" style={{ borderColor: '#1A1A1A', opacity: 0.15 }}>
            <div className="px-12 text-center">
              <h3 className="text-sm tracking-[0.4em] font-light mb-6" style={{ color: '#1A1A1A' }}>
                ARCHITECTURE
              </h3>
      ...
      <section id="contact-section" className="py-40 px-12 bg-white">
        <div className="max-w-[800px] mx-auto text-center">
          <h2 className="text-6xl mb-12" style={{ color: '#1A1A1A' }}>Let's Create</h2>

          <p className="text-base font-light mb-16 leading-relaxed" style={{ color: '#1A1A1A', opacity: 0.7 }}>
            We welcome inquiries for residential, commercial, and institutional projects.<br />
            For new project discussions, please reach us at
          </p>

          <a
            href="mailto:studio@arcus.design"
            className="text-2xl font-light hover:opacity-50 transition-opacity duration-300 inline-block border-b pb-1"
            style={{ color: '#C9B99A', borderColor: '#C9B99A' }}
          >
            studio@arcus.design
          </a>

          <div className="mt-24 pt-16 border-t" style={{ borderColor: '#1A1A1A', opacity: 0.1 }}>
            <div className="flex justify-center gap-16 text-xs tracking-[0.3em] font-light" style={{ color: '#1A1A1A', opacity: 0.5 }}>
              <p>LONDON</p>
              <p>NEW YORK</p>
              <p>TOKYO</p>
            </div>
      ...
      <footer className="bg-white" style={{ backgroundColor: '#F5F2EE' }}>
        ...
        <div className="max-w-[1600px] mx-auto px-12 py-24">
          <div className="grid grid-cols-4 gap-16 mb-20">
            <div>
              <p className="text-sm tracking-[0.4em] font-light mb-8" style={{ color: '#1A1A1A' }}>STUDIO</p>
            ...
            <div>
              <p className="text-sm tracking-[0.4em] font-light mb-8" style={{ color: '#1A1A1A' }}>LOCATIONS</p>
            ...
            <div>
              <p className="text-sm tracking-[0.4em] font-light mb-8" style={{ color: '#1A1A1A' }}>CONNECT</p>
              <div className="space-y-3 text-xs font-light">
                <button className="block hover:opacity-50 transition-opacity duration-300" style={{ color: '#1A1A1A', opacity: 0.6 }}>studio@arcus.design</button>
                <button className="block hover:opacity-50 transition-opacity duration-300" style={{ color: '#1A1A1A', opacity: 0.6 }}>+44 (0) 20 XXXX XXXX</button>
              </div>
            </div>

            <div>
              <p className="text-sm tracking-[0.4em] font-light mb-8" style={{ color: '#1A1A1A' }}>FOLLOW</p>
              <div className="space-y-3 text-xs font-light">
                <button className="block hover:opacity-50 transition-opacity duration-300" style={{ color: '#1A1A1A', opacity: 0.6 }}>Instagram</button>
                <button className="block hover:opacity-50 transition-opacity duration-300" style={{ color: '#1A1A1A', opacity: 0.6 }}>LinkedIn</button>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 flex justify-between items-center">
            <p className="text-xs font-light" style={{ color: '#1A1A1A', opacity: 0.4 }}>
              © 2024 ARCUS Studio. All rights reserved.
            </p>
            <div className="flex gap-12 text-xs tracking-[0.3em] font-light" style={{ color: '#1A1A1A', opacity: 0.4 }}>
